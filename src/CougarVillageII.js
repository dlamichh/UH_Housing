    ...
    return (
        <div class="Title">
            ...
            <ul>
                ...
                <li>CV I has bathtub/shower and toilet in same room while CV2 has a shower (no tub) in one room and toilet in the other.</li>
                <li>CV I is a stone throw away from moody dining hall, while if you live at CV2 you gotta walk around CV1 to get to moody.</li>
            </ul>
        </div>
    );
};

export default CougarVillageII;